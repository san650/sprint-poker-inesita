class GameScreen
  ...
  def render
    div class: 'container game-screen' do
      div class: 'col-xs-12 col-sm-12 col-md-12 logo' do
        img src: '/static/logo-big.png'
      end
      div class: 'col-xs-12 col-sm-12 col-md-12 panel' do
        div class: 'col-xs-8 col-sm-8 col-md-8' do
        ...
        div class: 'col-xs-4 col-sm-4 col-md-4 sidebar' do
